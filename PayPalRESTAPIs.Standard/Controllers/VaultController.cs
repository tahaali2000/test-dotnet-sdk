...
namespace PayPalRESTAPIs.Standard.Controllers
{
    ...
    public class VaultController : BaseController
    {
        ...
        /// <returns>Returns the Models.PaymentTokenResponse response from the API call.</returns>
        public Models.PaymentTokenResponse PaymentTokensCreate(
        ...
        /// <returns>Returns the Models.PaymentTokenResponse response from the API call.</returns>
        public async Task<Models.PaymentTokenResponse> PaymentTokensCreateAsync(
                Models.PaymentTokensCreateInput input,
        ...
        /// </summary>
        /// <param name="input">Object containing request parameters.</param>
        /// <returns>Returns the Models.CustomerVaultPaymentTokensResponse response from the API call.</returns>
        public Models.CustomerVaultPaymentTokensResponse CustomerPaymentTokensGet(
        ...
        /// <param name="cancellationToken"> cancellationToken. </param>
        /// <returns>Returns the Models.CustomerVaultPaymentTokensResponse response from the API call.</returns>
        public async Task<Models.CustomerVaultPaymentTokensResponse> CustomerPaymentTokensGetAsync(
                Models.CustomerPaymentTokensGetInput input,
                CancellationToken cancellationToken = default)
        ...
        /// <returns>Returns the Models.PaymentTokenResponse response from the API call.</returns>
        public Models.PaymentTokenResponse PaymentTokensGet(
                string id)
        ...
        /// <param name="cancellationToken"> cancellationToken. </param>
        /// <returns>Returns the Models.PaymentTokenResponse response from the API call.</returns>
        public async Task<Models.PaymentTokenResponse> PaymentTokensGetAsync(
                string id,
                CancellationToken cancellationToken = default)
            => await CreateApiCall<Models.PaymentTokenResponse>()
              .RequestBuilder(_requestBuilder => _requestBuilder
        ...
        /// </summary>
        /// <param name="input">Object containing request parameters.</param>
        /// <returns>Returns the Models.SetupTokenResponse response from the API call.</returns>
        public Models.SetupTokenResponse SetupTokensCreate(
        ...
        /// <param name="cancellationToken"> cancellationToken. </param>
        /// <returns>Returns the Models.SetupTokenResponse response from the API call.</returns>
        public async Task<Models.SetupTokenResponse> SetupTokensCreateAsync(
                Models.SetupTokensCreateInput input,
                CancellationToken cancellationToken = default)
        ...
        /// <returns>Returns the Models.SetupTokenResponse response from the API call.</returns>
        public Models.SetupTokenResponse SetupTokensGet(
                string id)
        ...
        /// <param name="cancellationToken"> cancellationToken. </param>
        /// <returns>Returns the Models.SetupTokenResponse response from the API call.</returns>
        public async Task<Models.SetupTokenResponse> SetupTokensGetAsync(
                string id,
                CancellationToken cancellationToken = default)
            => await CreateApiCall<Models.SetupTokenResponse>()
              .RequestBuilder(_requestBuilder => _requestBuilder
