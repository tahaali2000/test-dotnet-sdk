...
namespace PayPalRESTAPIs.Standard.Controllers
{
    ...
    public class OrdersController : BaseController
    {
        ...
        public Models.Order OrdersCreate(
        ...
        /// <returns>Returns the Models.Order response from the API call.</returns>
        public async Task<Models.Order> OrdersCreateAsync(
                Models.OrdersCreateInput input,
        ...
        /// <param name="cancellationToken"> cancellationToken. </param>
        /// <returns>Returns the Models.Order response from the API call.</returns>
        public async Task<Models.Order> OrdersGetAsync(
                Models.OrdersGetInput input,
                CancellationToken cancellationToken = default)
            => await CreateApiCall<Models.Order>()
              .RequestBuilder(_requestBuilder => _requestBuilder
        ...
        /// <param name="input">Object containing request parameters.</param>
        /// <returns>Returns the Models.Order response from the API call.</returns>
        public Models.Order OrdersConfirm(
        ...
        /// <param name="cancellationToken"> cancellationToken. </param>
        /// <returns>Returns the Models.Order response from the API call.</returns>
        public async Task<Models.Order> OrdersConfirmAsync(
                Models.OrdersConfirmInput input,
                CancellationToken cancellationToken = default)
            => await CreateApiCall<Models.Order>()
              .RequestBuilder(_requestBuilder => _requestBuilder
        ...
        /// </summary>
        /// <param name="input">Object containing request parameters.</param>
        /// <returns>Returns the Models.OrderAuthorizeResponse response from the API call.</returns>
        public Models.OrderAuthorizeResponse OrdersAuthorize(
        ...
        /// <param name="cancellationToken"> cancellationToken. </param>
        /// <returns>Returns the Models.OrderAuthorizeResponse response from the API call.</returns>
        public async Task<Models.OrderAuthorizeResponse> OrdersAuthorizeAsync(
                Models.OrdersAuthorizeInput input,
                CancellationToken cancellationToken = default)
        ...
        /// <param name="input">Object containing request parameters.</param>
        /// <returns>Returns the Models.Order response from the API call.</returns>
        public Models.Order OrdersCapture(
        ...
        /// <param name="cancellationToken"> cancellationToken. </param>
        /// <returns>Returns the Models.Order response from the API call.</returns>
        public async Task<Models.Order> OrdersCaptureAsync(
                Models.OrdersCaptureInput input,
                CancellationToken cancellationToken = default)
            => await CreateApiCall<Models.Order>()
              .RequestBuilder(_requestBuilder => _requestBuilder
        ...
        /// <param name="input">Object containing request parameters.</param>
        /// <returns>Returns the Models.Order response from the API call.</returns>
        public Models.Order OrdersTrackCreate(
        ...
        /// <param name="cancellationToken"> cancellationToken. </param>
        /// <returns>Returns the Models.Order response from the API call.</returns>
        public async Task<Models.Order> OrdersTrackCreateAsync(
                Models.OrdersTrackCreateInput input,
                CancellationToken cancellationToken = default)
            => await CreateApiCall<Models.Order>()
              .RequestBuilder(_requestBuilder => _requestBuilder
