...
namespace PayPalRESTAPIs.Standard.Controllers
{
    ...
    public class PaymentsController : BaseController
    {
        ...
        /// <returns>Returns the Models.PaymentAuthorization response from the API call.</returns>
        public Models.PaymentAuthorization AuthorizationsGet(
        ...
        /// <returns>Returns the Models.PaymentAuthorization response from the API call.</returns>
        public async Task<Models.PaymentAuthorization> AuthorizationsGetAsync(
                string authorizationId,
        ...
        /// <returns>Returns the Models.CapturedPayment response from the API call.</returns>
        public Models.CapturedPayment AuthorizationsCapture(
        ...
        /// <param name="cancellationToken"> cancellationToken. </param>
        /// <returns>Returns the Models.CapturedPayment response from the API call.</returns>
        public async Task<Models.CapturedPayment> AuthorizationsCaptureAsync(
                Models.AuthorizationsCaptureInput input,
                CancellationToken cancellationToken = default)
        ...
        /// <param name="input">Object containing request parameters.</param>
        /// <returns>Returns the Models.PaymentAuthorization response from the API call.</returns>
        public Models.PaymentAuthorization AuthorizationsReauthorize(
        ...
        /// <param name="cancellationToken"> cancellationToken. </param>
        /// <returns>Returns the Models.PaymentAuthorization response from the API call.</returns>
        public async Task<Models.PaymentAuthorization> AuthorizationsReauthorizeAsync(
                Models.AuthorizationsReauthorizeInput input,
                CancellationToken cancellationToken = default)
            => await CreateApiCall<Models.PaymentAuthorization>()
              .RequestBuilder(_requestBuilder => _requestBuilder
        ...
        /// <param name="input">Object containing request parameters.</param>
        /// <returns>Returns the Models.PaymentAuthorization response from the API call.</returns>
        public Models.PaymentAuthorization AuthorizationsVoid(
        ...
        /// <param name="cancellationToken"> cancellationToken. </param>
        /// <returns>Returns the Models.PaymentAuthorization response from the API call.</returns>
        public async Task<Models.PaymentAuthorization> AuthorizationsVoidAsync(
                Models.AuthorizationsVoidInput input,
                CancellationToken cancellationToken = default)
            => await CreateApiCall<Models.PaymentAuthorization>()
              .RequestBuilder(_requestBuilder => _requestBuilder
        ...
        /// <returns>Returns the Models.CapturedPayment response from the API call.</returns>
        public Models.CapturedPayment CapturesGet(
                string captureId)
        ...
        /// <param name="cancellationToken"> cancellationToken. </param>
        /// <returns>Returns the Models.CapturedPayment response from the API call.</returns>
        public async Task<Models.CapturedPayment> CapturesGetAsync(
                string captureId,
                CancellationToken cancellationToken = default)
            => await CreateApiCall<Models.CapturedPayment>()
              .RequestBuilder(_requestBuilder => _requestBuilder
        ...
        /// </summary>
        /// <param name="input">Object containing request parameters.</param>
        /// <returns>Returns the Models.Refund response from the API call.</returns>
        public Models.Refund CapturesRefund(
        ...
        /// <param name="cancellationToken"> cancellationToken. </param>
        /// <returns>Returns the Models.Refund response from the API call.</returns>
        public async Task<Models.Refund> CapturesRefundAsync(
                Models.CapturesRefundInput input,
                CancellationToken cancellationToken = default)
        ...
        /// <returns>Returns the Models.Refund response from the API call.</returns>
        public Models.Refund RefundsGet(
                string refundId)
        ...
        /// <param name="cancellationToken"> cancellationToken. </param>
        /// <returns>Returns the Models.Refund response from the API call.</returns>
        public async Task<Models.Refund> RefundsGetAsync(
                string refundId,
                CancellationToken cancellationToken = default)
            => await CreateApiCall<Models.Refund>()
              .RequestBuilder(_requestBuilder => _requestBuilder
